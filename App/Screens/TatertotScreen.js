...
export default class TatertotScreen extends React.Component {
      ...
      <SafeAreaView style={styles.container}>
        ...
        <ImageBackground source={require('../Images/Backgrounds/beach.jpg')} imageStyle={{resizeMode: 'cover'}} style={styles.backgroundImage} >
          ...
          <View styles={styles.forefront}>
            ...
            <Image style={styles.avatar} resizeMode={'contain'} source={require('../Images/tatertot29_with_name.png')} />
            <Button 
              style={styles.button}
